"""Run an interview session against a synthetic respondent — no voice.
...
This module is importable from the installed package, so ``interview_kit
...
from interview_kit import Background, Engine, EvalResult, Extract, Goal, Persona
